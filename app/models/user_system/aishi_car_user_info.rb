class UserSystem::AishiCarUserInfo < ActiveRecord::Base
  ...
  CITY = [ "上海","福州", "厦门", '苏州', "杭州", "成都"
      # '天津', '苏州', '武汉', '重庆', "上海", "杭州", "成都","福州", "厦门","深圳","南京","广州","东莞","佛山",
  # "郑州", "长沙", "西安", "青岛", "威海", "烟台",
  ...
  def self.get_key_numbers city_name
    if ['太原', '郑州', '长沙', '运城', '晋中', '临汾', "深圳","南京","广州","佛山",'大同', "兰州", "呼和浩特", "大连", "贵阳", "惠州", "嘉兴", "中山", "肇庆", "绵阳", "襄阳", "宜昌"].include? city_name
