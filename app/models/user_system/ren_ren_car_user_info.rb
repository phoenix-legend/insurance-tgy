class UserSystem::RenRenCarUserInfo < ActiveRecord::Base
  ...
  CITY = ["北京", "东莞", "佛山", "深圳", "南宁", "杭州", "南京", "长沙", "合肥", "厦门", "太原",
          ...
          "西安", "兰州", "成都", "贵阳", "苏州", "南通", "乌鲁木齐", "潍坊", "肇庆", "福州", "咸阳", "烟台", "宁波", "泉州", "南昌", "保定", "呼和浩特","襄阳", "唐山", "南阳","新乡","嘉兴","菏泽",
          "鞍山","东营","济宁","南充","安阳","包头","镇江","抚顺","湘潭","锦州","中山",
          "达州","宜宾","淄博","台州","十堰","宜昌","邯郸","泸州","南充","桂林","台州","湖州","营口","绍兴",
          "蚌埠","沧州","淮安","莆田", "漳州", "镇江"
  ...
  #     UserSystem::RenRenCarUserInfo.create_user_info_from_car_user_info cui
  #   end
  # end
