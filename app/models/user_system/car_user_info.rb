class UserSystem::CarUserInfo < ActiveRecord::Base
  ...
  def self.upload_to_haoche
    car_user_infos = UserSystem::CarUserInfo.where "(upload_status = 'weidaoru' or (upload_status = 'shibai' and shibaiyuanyin = 'AuthCode is Wrong--E013')) and id > 93637 and fabushijian > '2015-09-7'"
