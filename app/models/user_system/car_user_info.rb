class UserSystem::CarUserInfo < ActiveRecord::Base
  ...
  ALL_CITY = {"310100" => "上海", "510100" => "成都", "440300" => "深圳", "320100" => "南京", "440100" => "广州", "420100" => "武汉",
              ...
              "130100" => "石家庄", "130200" => "唐山", "140100" => "太原", "610400" => "咸阳", "610300" => "宝鸡", "410300" => "洛阳", "411300" => "南阳", "410700" => "新乡", "110100" => "北京",
              "430300" => "湘潭", "430200" => "株洲", "430700" => "常德", "430600" => "岳阳", "210100" => "沈阳", "210200" => "大连", "210800" => "营口",
               "350200" => "厦门", "350500" => "泉州", "220100" => "长春", "230100" => "哈尔滨", "230600" => "大庆", "340100" => "合肥", "340200" => "芜湖", "450100" => "南宁", "360100" => "南昌",
    ...
    case sub_party
      ...
      when 1
      ...
      else
        {
            ...
            "520300" => "遵义", "510700" => "绵阳", "420600" => "襄阳", "420500" => "宜昌",
            "371600" => "滨州", "371400" => "德州", "370500" => "东营", "370800" => "济宁", "371300" => "临沂", "371100" => "日照", "370900" => "泰安", "370400" => "枣庄", "330200" => "宁波", "321300" => "宿迁", "321200" => "泰州", "320900" => "盐城", "321100" => "镇江",
            # 最后一大波，逐批开放， ********
            "440700" => "江门", "440500" => "汕头", "440400" => "珠海", "370300" => "淄博", "330500" => "湖州", "330700" => "金华", "331100" => "丽水", "330800" => "衢州", "330600" => "绍兴", "331000" => "台州", "330300" => "温州", "320800" => "淮安", "320700" => "连云港", "320900" => "盐城", "130600" => "保定",
            "130800" => "承德", "130900" => "沧州", "131100" => "衡水", "130400" => "邯郸", "131000" => "廊坊", "130300" => "秦皇岛", "130500" => "邢台", "130700" => "张家口", "410500" => "安阳", "410800" => "焦作", "410200" => "开封", "411100" => "漯河", "410400" => "平顶山", "411400" => "商丘", "411500" => "信阳",
  ...
  def self.get_baixing_sub_cities sub_party = 0
    case sub_party
      when 0
        {
            "shanghai" => "上海", "chengdu" => "成都", "shenzhen" => "深圳", "nanjing" => "南京", "wuhan" => "武汉", "tianjin" => "天津", "suzhou" => "苏州", "xiamen" => "厦门",
  ...
  def self.get_city_code_name
    need_cities = ["自贡", "淄博", "资阳", "驻马店", "珠海", "长治", "漳州", "张家口", "玉林", "益阳", "义乌", "宜春",
