class UserSystem::CarUserInfo < ActiveRecord::Base
  ...
  CITY3 = ["威海", "烟台", "潍坊", "兰州", "徐州", "南通", "扬州", "济南", "石家庄", "唐山", "洛阳", "南阳", "新乡", "湘潭", "株洲", "常德", "岳阳", "沈阳", "大连", "营口", "乌鲁木齐", "泉州", "长春", "哈尔滨", "大庆", "滁州", "芜湖", "惠州", "肇庆", "中山", "嘉兴", "贵阳", "呼和浩特", "绵阳", "襄阳", "宜昌", "大同", "临汾", "运城", "滨州", "德州", "东营", "济宁", "临沂", "日照", "泰安", "枣庄", "宿迁", "泰州", "盐城", "镇江", "自贡", "淄博", "资阳", "驻马店", "珠海", "长治", "漳州", "宜春", "宜宾", "许昌", "邢台", "信阳", "孝感", "温州", "台州", "遂宁", "松原", "十堰", "绍兴", "汕头", "曲靖", "衢州", "秦皇岛", "齐齐哈尔", "莆田", "内江", "南充", "眉山", "马鞍山", "泸州", "六安", "柳州", "辽阳", "乐山", "廊坊", "开封", "荆州", "锦州", "金华", "焦作", "江门", "佳木斯", "吉林", "吉安", "黄石", "淮安", "湖州", "衡水", "邯郸", "桂林", "广安", "赣州", "阜阳", "抚顺", "福州", "鄂尔多斯", "德阳", "达州", "承德", "沧州", "保定", "包头", "鞍山", "安阳", "安庆", "蚌埠", "咸阳", "银川", "菏泽", "铜陵", "黄冈","连云港"]
