class UserSystem::CarUserInfo < ActiveRecord::Base
  ...
  ALL_CITY = {"310100" => "上海", "510100" => "成都", "440300" => "深圳", "320100" => "南京", "440100" => "广州",
              ...
              "110100" => "北京", "410100" => "郑州", "430100" => "长沙", "610100" => "西安", "370200" => "青岛", "320200" => "无锡"}  # 缺镇江
  ...
  PINYIN_CITY = {
      ...
      "dongguan" => "东莞", "chongqing" => "重庆","beijing" => "北京","zhengzhou" => '郑州','changsha' => '长沙', 'xian' => '西安', "qingdao" => "青岛", 'zhenjiang' => '镇江', "wuxi" => "无锡"
  }
  ...
  GANJI_CITY = {
      ...
      "wh" => "武汉", "tj" => "天津", "su" => "苏州", "hz" => "杭州", "dg" => "东莞", "cq" => "重庆", 'bj' => '北京', 'zz' => '郑州','cs' => '长沙', 'xa' => '西安','qd' => '青岛','zj' => '镇江', "wx" => "无锡"
  }
