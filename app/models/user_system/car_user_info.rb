class UserSystem::CarUserInfo < ActiveRecord::Base
  ...
  ALL_CITY = {"310100" => "上海", "510100" => "成都", "440300" => "深圳", "320100" => "南京", "440100" => "广州", "420100" => "武汉",
              ...
              "370900" => "泰安", "370400" => "枣庄", "330200" => "宁波", "321300" => "宿迁", "321200" => "泰州", "320900" => "盐城",
              "321100" => "镇江",
              # 最后一大波，逐批开放，
  ...
  def self.upload_guozheng
    ...
    cuis = UserSystem::CarUserInfo.where("tt_source in ('2-474','2-474-602','2-474-602') and tt_id is not null and id > 2301992")
