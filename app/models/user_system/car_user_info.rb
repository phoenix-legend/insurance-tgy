class UserSystem::CarUserInfo < ActiveRecord::Base
  ...
  CITY1 = ['上海','成都','杭州','苏州','福州','合肥']
  CITY2 = ['深圳','南京','广州','武汉','佛山','天津','东莞','重庆','厦门','北京']
  CITY3 = ["西安", "青岛", "威海", "烟台", "潍坊", "无锡", "兰州", "郑州", "太原", "长沙", "常州", "徐州", "南通", "扬州", "济南", "石家庄", "唐山", "宝鸡", "宿州", "洛阳",
           "南阳", "新乡", "湘潭", "株洲", "常德", "岳阳", "沈阳", "大连", "营口", "乌鲁木齐", "泉州", "长春", "哈尔滨", "大庆", "芜湖", "南宁", "南昌", "惠州", "肇庆",
           "中山", "嘉兴", "贵阳", "遵义", "呼和浩特", "绵阳", "襄阳", "宜昌", "大同", "晋中", "临汾", "运城", "滨州", "德州", "东营", "济宁", "临沂", "日照", "泰安", "枣庄",
           "宁波", "宿迁", "泰州", "盐城", "镇江", "自贡", "淄博", "资阳", "驻马店", "珠海", "长治", "漳州", "张家口", "玉林", "益阳", "义乌", "宜春", "宜宾", "延边", "雅安",
           ...
           "连云港", "乐山", "廊坊", "昆明", "开封", "九江", "景德镇", "荆州", "荆门", "锦州", "金华", "焦作", "江门", "佳木斯", "吉林", "吉安", "黄石", "淮安", "湖州", "衡水",
